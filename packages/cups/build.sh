...
TERMUX_PKG_SHA256=dd54228dd903526428ce7e37961afaed230ad310788141da75cebaa08362cf6c
TERMUX_PKG_AUTO_UPDATE=true
TERMUX_PKG_DEPENDS="libandroid-support (>= 31), libc++, libcrypt, libgnutls, libiconv, zlib"
